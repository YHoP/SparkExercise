    ...
    "<!DOCTYPE html>" +
      ...
      "<body>" +
        "<h1>Favorite Traveling Photos</h1>" +
          "<ul>" +
            "<li><img src='/images/BRVerdoorn.jpg' alt='Photo by B.R. Verdoorn.'/></li>" +
            "<li><img src='/images/MBaird.jpg' alt='Photo by M. Baird.'/></li>" +
            "<li><img src='/images/SGabriel.jpg' alt='Photo by S. Gabriel.'/></li>" +
          "</ul>" +
      "</body>" +
      "</html>"
    );
